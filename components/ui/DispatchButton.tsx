...
// import { FC, FormEvent, LegacyRef, MouseEventHandler, ReactNode } from 'react'
// /* کار نمیکنه */
// type Buttons = {
//     color?: string
//     size?: string
...
// const DispatchButton: FC<Buttons> = ({
//     color,
//     size,
//     children,
//     ref
...
//                 break;
//             case 'dark':
//                 btnColor = 'bg-gray-800 hover:bg-gray-900 focus:ring-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 text-white dark:text-gray-400'
//                 break;
//             case 'light':
...
//                 `${btnSize}  
//                 ${btnColor} 
//                 flex gap-2 justify-around items-center text-center focus:ring-4 rounded-lg focus:outline-none `
//             }
//         >
