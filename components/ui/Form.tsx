    ...
    return (
        <div> <form>
            <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                ...
                <div><label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an option</label>
                ...
                >
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        <span className="mr-3 text-sm font-medium text-gray-900 dark:text-gray-300">Toggle me</span>
                    </label>
