const InputTheme = {
  ...
  input:
    "peer border block min-h-[auto] w-full shadow-md rounded border-neutral-400 bg-transparent outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary motion-reduce:transition-none placeholder:opacity-0 disabled:bg-neutral-100 read-only:bg-neutral-100 dark:disabled:bg-neutral-700 dark:read-only:bg-neutral-700 dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary",
  activeInput: "placeholder:opacity-100",
  label:
    "pointer-events-none text-sm absolute right-2 top-0 mb-0 max-w-[90%] origin-[0_0] truncate text-neutral-700 transition-all duration-200 ease-out peer-focus:scale-[0.8] peer-focus:text-white py-1 px-2 rounded-lg peer-focus:bg-primary dark:peer-focus:bg-neutral-800 dark:peer-focus:border dark:peer-focus:border-primary dark:peer-focus:text-neutral-200 motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-neutral-200",
  activeLabel: "scale-[0.8] border dark:bg-neutral-800 dark:text-white border-neutral-400 bg-neutral-200 text-xs",
  notch:
