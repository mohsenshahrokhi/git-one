...
// import { SetThemeDark, SetThemeLight } from "@/slices/ThemeSlice"
...
const ThemeSwitcher: React.FC = (): JSX.Element => {
  ...
  // const displayTheme = { theme: { displayTheme: 'light' } }
  // const displayTheme = useAppSelector((state) => state.themeMode)
  ...
  //       : setDarkTheme()
  //     return
  //   } else if (displayTheme.theme.displayTheme === "dark") {
  //     setLightTheme()
  //   } else {
  //     setDarkTheme()
  //   }
  ...
  useEffect(() => {
    ...
    // setActiveTheme(JSON.parse(themeMode || 'lirgt').displayTheme)
  }, [])
